...
class FedBNSerialClientTrainer(FedAvgSerialClientTrainer):
    ...
    def local_process(self, payload, id_list):
        ...
        for idx in id_list:
            ...
            for epoch in range(self.max_epoch):
                ...
                loss, mi_dice, ma_dice, hd = self.global_test(idx, epoch)
                avg_metric[0] += loss
                avg_metric[1] += mi_dice
                avg_metric[2] += ma_dice
                avg_metric[3] += hd
        ...
        wandb.log({
                ...
                f"avg_global_test_micro_dice": avg_metric[1],
                f"avg_global_test_macro_dice": avg_metric[2],
                f"avg_global_test_hd": avg_metric[3]
            },
    ...
    def train(self, epoch, idx):
        ...
        return [model_parameters, metric[-1]]
    ...
    def global_test(self, idx, epoch: int):
        ...
        return metric[0] / metric[-1], metric[1] / metric[-1], metric[2] / metric[-1], metric[3] / metric[-1]