...
from algorithm.ecg.fedfa import FedFaServerHandler, FedFaSerialClientTrainer
...
parser.add_argument("--momentum_round", type=int, default=1)
parser.add_argument("--model", type=str, default="resnet1d34")
parser.add_argument("--mode", type=str, default="fedfa")
parser.add_argument("--communication_round", type=int, default=50)
parser.add_argument("--case_name", type=str, default="fedfa_ecg")
...
if __name__ == "__main__":
    ...
    setting = {
        ...
        "beta": args.beta,
        "gamma": args.gamma,
        "momentum_round": args.momentum_round,
        "criterion": "BCELoss",
    ...
    trainer = FedFaSerialClientTrainer(
        model=model,
        num_clients=num_clients,
