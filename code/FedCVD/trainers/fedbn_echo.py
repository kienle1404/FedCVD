...
from algorithm.echo.fedbn import FedBNServerHandler, FedBNSerialClientTrainer
...
parser.add_argument("--case_name", type=str, default="fedbn_echo")
...
if __name__ == "__main__":
    ...
    trainer = FedBNSerialClientTrainer(
        model=model,
        num_clients=num_clients,
